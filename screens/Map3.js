      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ width: "100%" }}>
        ...
        <TouchableOpacity>
          <View style={{
            ...
            <Text style={{ fontSize: 16, fontWeight: "bold" }}>Event 1</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity>
          <View style={{
            ...
            <Text style={{ fontSize: 16, fontWeight: "bold" }}>Event 2</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity>
          <View style={{
            ...
            <Text style={{ fontSize: 16, fontWeight: "bold" }}>Event 3</Text>
          </View>
        </TouchableOpacity>
